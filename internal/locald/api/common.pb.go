...
func (*SandboxStatus_Baseline) Descriptor() ([]byte, []int) {
	return file_internal_locald_api_common_proto_rawDescGZIP(), []int{7, 0}
}
...
func (*SandboxStatus_BaselineToLocal) Descriptor() ([]byte, []int) {
	return file_internal_locald_api_common_proto_rawDescGZIP(), []int{7, 1}
}
...
func (*SandboxStatus_LocalWorkload) Descriptor() ([]byte, []int) {
	return file_internal_locald_api_common_proto_rawDescGZIP(), []int{7, 2}
}
...
var file_internal_locald_api_common_proto_rawDesc = []byte{
	...
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x77, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x22, 0x6a,
...
var file_internal_locald_api_common_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_internal_locald_api_common_proto_goTypes = []interface{}{
	...
	(*PortForwardStatus)(nil),             // 4: apicommon.PortForwardStatus
	(*ControlPlaneProxyStatus)(nil),       // 5: apicommon.ControlPlaneProxyStatus
	(*WatcherStatus)(nil),                 // 6: apicommon.WatcherStatus
	(*SandboxStatus)(nil),                 // 7: apicommon.SandboxStatus
	(*OperatorInfo)(nil),                  // 8: apicommon.OperatorInfo
	(*DevboxSessionStatus)(nil),           // 9: apicommon.DevboxSessionStatus
	(*SandboxStatus_Baseline)(nil),        // 10: apicommon.SandboxStatus.Baseline
	(*SandboxStatus_BaselineToLocal)(nil), // 11: apicommon.SandboxStatus.BaselineToLocal
	(*SandboxStatus_LocalWorkload)(nil),   // 12: apicommon.SandboxStatus.LocalWorkload
	(*timestamppb.Timestamp)(nil),         // 13: google.protobuf.Timestamp
}
var file_internal_locald_api_common_proto_depIdxs = []int32{
	13, // 0: apicommon.ServiceHealth.last_error_time:type_name -> google.protobuf.Timestamp
	...
	13, // 3: apicommon.HostsStatus.last_update_time:type_name -> google.protobuf.Timestamp
	0,  // 4: apicommon.LocalDNSStatus.health:type_name -> apicommon.ServiceHealth
	13, // 5: apicommon.LocalDNSStatus.last_refresh:type_name -> google.protobuf.Timestamp
	...
	12, // 9: apicommon.SandboxStatus.local_workloads:type_name -> apicommon.SandboxStatus.LocalWorkload
	13, // 10: apicommon.DevboxSessionStatus.last_error_time:type_name -> google.protobuf.Timestamp
	10, // 11: apicommon.SandboxStatus.LocalWorkload.baseline:type_name -> apicommon.SandboxStatus.Baseline
	11, // 12: apicommon.SandboxStatus.LocalWorkload.workloadPortMapping:type_name -> apicommon.SandboxStatus.BaselineToLocal
